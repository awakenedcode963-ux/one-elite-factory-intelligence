...
echo "Running FI-13.3 Negative Architectural Tests..."
...
run_test "Agent -> Agent" "packages/agents/src/index.ts" "import { AgentDefinition as Other } from '../../agents/src/index.js'; console.log(Other);"

echo "All Selected Negative Tests Attempted."
